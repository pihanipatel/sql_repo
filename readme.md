...
The following is the flowchart for the project. It is embedded in this single README file, so no separate flowchart file is required.

```svg
<svg xmlns="http://www.w3.org/2000/svg" width="1000" height="720" viewBox="0 0 1000 720">
<rect width="100%" height="100%" fill="white"/>
<style>
.title{font:700 28px Arial;fill:#222}.head{font:700 18px Arial;fill:#222}.body{font:14px Arial;fill:#333}.arrow{stroke:#333;stroke-width:2;fill:none;marker-end:url(#arrow)}
.box{fill:#f7f7f7;stroke:#333;stroke-width:2;rx:12}
</style>
...
<text x="500" y="45" text-anchor="middle" class="title">SQL Database Project – Table Flow</text>
<rect x="350" y="75" width="300" height="75" class="box"/>
<text x="500" y="105" text-anchor="middle" class="head">SQL DATABASE PROJECT</text>
<text x="500" y="130" text-anchor="middle" class="body">CREATE → INSERT → SELECT → UPDATE → DELETE</text>
<path d="M500 150 L500 190" class="arrow"/>
<rect x="70" y="205" width="240" height="155" class="box"/>
<text x="190" y="235" text-anchor="middle" class="head">Customers_table</text>
<text x="90" y="265" class="body">CustomerID (PK)</text>
<text x="90" y="290" class="body">Name</text>
<text x="90" y="315" class="body">Email</text>
<text x="90" y="340" class="body">Address</text>
<rect x="380" y="205" width="240" height="155" class="box"/>
<text x="500" y="235" text-anchor="middle" class="head">Orders_table</text>
<text x="400" y="265" class="body">OrderID (PK)</text>
<text x="400" y="290" class="body">CustomerID</text>
<text x="400" y="315" class="body">OrderDate</text>
<text x="400" y="340" class="body">TotalAmount</text>
<rect x="690" y="205" width="240" height="155" class="box"/>
<text x="810" y="235" text-anchor="middle" class="head">Products_table</text>
<text x="710" y="265" class="body">productID</text>
<text x="710" y="290" class="body">productName</text>
<text x="710" y="315" class="body">price</text>
<text x="710" y="340" class="body">stock</text>
<path d="M310 282 L380 282" class="arrow"/>
<path d="M620 282 L690 282" class="arrow"/>
<path d="M500 360 L500 430" class="arrow"/>
<rect x="350" y="445" width="300" height="155" class="box"/>
<text x="500" y="475" text-anchor="middle" class="head">Orderdetails_table</text>
<text x="370" y="505" class="body">OrderdetailID (PK)</text>
<text x="370" y="530" class="body">OrderID</text>
<text x="370" y="555" class="body">ProductID</text>
<text x="370" y="580" class="body">Quantity, SubTotal</text>
<text x="500" y="650" text-anchor="middle" class="body">Note: relationships are implied by column names; the SQL does not define FOREIGN KEY constraints.</text>
</svg>
```
